...
declare namespace fhirclient {
    ...
    interface Client {
         ...
         */
        create(resource: object): Promise<any>
         ...
         */
        update(resource: object): Promise<any>
         ...
         */
        request(uri: string, fhirOptions?: FhirOptions, _resolvedRefs?: object): Promise<any>
        request(url: URL, fhirOptions?: FhirOptions, _resolvedRefs?: object): Promise<any>;
        request(requestOptions: any, fhirOptions?: FhirOptions, _resolvedRefs?: object): Promise<any>;
